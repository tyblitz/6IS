<template>
  <MainLayout title="Annual Report" username="Admin">
    <div class="report-page-container">
      ...
      <div class="module-header-bar print-hide">
        <div>
          <h2>Annual Report</h2>
          <p class="subtitle">Read-only consolidated annual accomplishment report.</p>
        </div>
      ...
      <div class="printable-header print-only">
        ...
        <div class="print-report-title">ANNUAL ACCOMPLISHMENT REPORT</div>
        <div class="print-meta">Year: {{ selectedYear }} | Generated: {{ new Date().toLocaleString() }}</div>
      </div>
      ...
      <div class="stats-strip print-hide">
        <div class="stat-pill">
          <span>Total Annual Accomplishments:</span>
      ...
      <div class="table-card">
        <div v-if="loading" class="state-container print-hide">
          ...
          <span>Consolidating annual report records...</span>
        </div>
        ...
        <div v-else-if="records.length === 0" class="state-container empty-box print-hide">
          ...
          <p>No accomplishments recorded for year {{ selectedYear }}.</p>
        </div>
...
import { fetchAnnualAccomplishments, fetchAccomplishmentOptions } from '../../services/accomplishmentService'
